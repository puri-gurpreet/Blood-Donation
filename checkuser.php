...
else
{
	echo'<script>alert("data is not inserted")</script>';
		...
		{
			 $hid=$_POST['hid'];
             $qry="update tbl_checkuser set username='$usrnm',email='$email',contact='$cont',address='$add'
			 ,bloodgroup='$bld' where id=$hid";
			$res=mysqli_query($con,$qry);
			if($res)
			{
...
<center>username <input type="text" name="username" placeholder="enter username" value="<?php echo $usrnm; ?>"></br></br>
email <input type="email" name="email" placeholder="enter email" value="<?php echo $email; ?>"></br></br>
contact <input type="number" name="contact" placeholder=" enter contact number" value="<?php echo $cont; ?>"></br></br>
address <textarea rows="" cols="" name="address" placeholder="enter address"><?php echo $add; ?></textarea></br></br>
bloodgroup <input type="text" name="bloodgroup" placeholder="enter bloodgroup" value="<?php echo $bld; ?>"></br></br>
