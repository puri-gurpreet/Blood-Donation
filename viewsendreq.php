...
//$id=$_POST['uid'];
		...
		{
echo '<tr><td>'.$row['id'].'</td> <td>'.$row['bloodgroup'].'</td> <td>'.$row['no_of_unit'].'</td> <td>'.$row['camp_address'].'</td><td>'.$row['contact_no'].'</td><td>
<a href="sendreq.php?editid='.$row['id'].'">Edit</td></tr>';
		}
		echo '</table></center>';
