...
<h2 class="text-center"> Register Doner</h2>
...
<b>Blood Group</b>    
<input type="radio" value="A+" name="bloodgroup">  A+    
<input type="radio" value="A-" name="bloodgroup">  A- 
  <input type="radio" value="B+"name="bloodgroup">  B+ 
  <input type="radio" value="B-"name="bloodgroup"> B- 
  <input type="radio" value="O+"name="bloodgroup"> O+ 
  <input type="radio" value="O-"name="bloodgroup"> O- 
 </br>
</div>
</div>
...
<div class="col-md-6">
 ...
 <div class="form-group">
<div class="col-md-6">
 <input class="btn btn-info btn-block" type="submit" name="submitbtn" value="submit">
</div>
</div>
</form>
 </div>
